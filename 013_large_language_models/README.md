...
| `03_arquitectura_transformer` | Análisis y desglose estructural de la arquitectura Transformer (Self-Attention) |
| `04_aplicaciones_transformers` | Tareas clásicas con pipelines de Transformers (clasificación, NER, traducción, etc.) |
| `05_generacion_texto_avanzada` | Estrategias de decodificación: Greedy, Beam Search, Sampling, Temperatura, Top-K y Top-P |
| `06_sumarizacion_aplicada` | Sumarización de documentos y archivos PDF usando Phi-3 e interfaces de Gradio |
| `07_introduccion_hugging_face` | Uso avanzado del ecosistema Hugging Face (Hub, Datasets, Pipelines y Modelos) |
| `08_arquitectura_gpt_desde_cero` | Construcción e implementación de una red GPT de principio a fin usando PyTorch |
